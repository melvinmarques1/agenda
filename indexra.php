...
<font face="Georgia">
 ...
 <div class="container" id="container">
    ...
    <em>Escreva seu R.A e clique em buscar, para saber sua sala, ou laborátorio</em><br><br>
    <!--Menu dropdownlist dos cursos-->
    <form method="POST" name="search" action="indexra.php">

      <div id="demo-grid">
            <div class="container" >
                <input type="text" class="form-control" name="R.A" placeholder="Digite seu R.A aqui"><br>
            ...
            <!--Começa a tabela-->
                <?php
                   ...
                   $cursoResult = $db_handle->runQuery("SELECT 'R.A' FROM academico ");
...
<div ><br>
<center>Desenvolvido pelo Apoio TI-FAC4<br><a href="index.php"><img src="voltar.png" width="30"/></a></center>
   </div>
 </font>   
     </body>
<!--Folha de estilo-->
