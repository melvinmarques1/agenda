        ...
        <div class="container">
          <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar" aria-expanded="false" aria-controls="navbar">
             ...
             <a href="indexpainel.php"><img src="logominiagenda.png" style="padding-top: 10px;" width="100"/></a>
          </div>
...
<!--Aqui começa a div com o conteudo-->
    <div style="text-align: center;"><img src="logoagendacognav3.png" width="300" style="padding-bottom: 50px;" /> <br /></div>
   
<span style="font-family: Georgia; ">
           <br /><br />  
           <div id="container" class="container">  
            <a href="historico.php"><button class="btn btn-danger" type="button"><i class="fas fa-angle-double-left"></i> Voltar</button></a>
                <h3>Edição de reservas</h3> <br>
                <center><em>Para editar, clique sobre o que deseja editar, altere o que deseja, e clique fora da area que editou e pronto <img src="feito.png"/></em></center>
                <br /> 
                <br /> 
                <div class="table-responsive"> 
                <!---Script para tornar a tabela editavel-->
     <script src="http://code.jquery.com/jquery-1.10.2.js"></script>

    </div>
   </div>
   <div style="text-align: center;"><h4>Desenvolvido pelo Apoio TI-FAC4</h4></div>
    ...
    function saveToDatabase(editableObj,column,id) {
        $(editableObj).css("background","#FFF url(feito.png) no-repeat right");
        $.ajax({
            url: "saveedit.php",
            type: "POST",
            data:'column='+column+'&editval='+editableObj.innerHTML+'&id='+id,
            success: function(data){
                $(editableObj).css("background","#81F781");
            }
        });
    }
    </script>
