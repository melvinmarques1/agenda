...
<html lang="pt-br">
	...
	<body>
		...
		$result_usuarios = "SELECT * FROM reservas LIMIT $inicio, $qnt_result_pg";
		$resultado_usuarios = mysqli_query($conn, $result_usuarios);
		while($row_usuario = mysqli_fetch_assoc($resultado_usuarios)){
			echo "ID: " . $row_usuario['id'] . "<br>";
			echo "Nome: " . $row_usuario['Curso'] . "<br>";
			echo "E-mail: " . $row_usuario['Sala'] . "<br><hr>";
		}
		
		//Paginção - Somar a quantidade de usuários
		$result_pg = "SELECT COUNT(id) AS num_result FROM reservas";
