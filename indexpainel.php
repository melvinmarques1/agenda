...
<font face="Georgia"> 
           <br /><br />  
<div >
	<!--<h1>Jquery Ajax Dropdown (onchange) in PHP</h1>-->
	<center>
	<h1>Seja bem-vindo ao Painel de Controle da Agenda Cogna</h1>
	<h4><em>Aqui você tem o controle completo do que vai acontecer na faculdade em alguns cliques.<br>
		
		Qualquer dúvida contacte o T.I de sua unidade.<br><br></em></h4>
	
	</div>
	<div class="col-md-1">
	</div>
	<div id="container" class="notice container col-md-5">
		<h4> Últimas reservas <i class="far fa-newspaper"></i> </h4><br>
		Em breve
	</div>
	<div class="col-md-1">
	</div>
	<div id="container" class="notice container col-md-4">
		<h4> Eventos importantes <i class="far fa-calendar-plus"></i></h4><br>
		Em breve
	</div>
	<div class="col-md-1">
		<br><br><br><br><br><br>
